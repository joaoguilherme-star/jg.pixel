    ...
    <section className="text-center">
      ...
      {showWhatsAppModal && (
        <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-4">
          <div className="bg-neutral-800 rounded-lg shadow-2xl p-8 max-w-md w-full text-center relative">
            <button
            ...
            <h3 className="text-3xl font-bold text-white mb-6">Contact via WhatsApp</h3>
            ...
            <a
              ...
              onClick={closeWhatsAppModal} // Close modal after clicking the link
              className="inline-flex items-center px-6 py-3 bg-green-500 text-white text-lg font-semibold rounded-full shadow-lg hover:bg-green-600 transition-all duration-300 transform hover:scale-105"
            >
